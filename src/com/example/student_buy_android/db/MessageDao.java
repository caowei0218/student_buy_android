...
public class MessageDao {
	...
	public List<Message> getMessage(String sender, String receiver) {
		...
		SQLiteDatabase db = db_helper.getWritableDatabase();
		Cursor cursor = null;
		String sql = "select * from (select * from chat_content where sender=? and receiver=? union select * from chat_content where sender=? and receiver=?)as temp order by temp.id";
