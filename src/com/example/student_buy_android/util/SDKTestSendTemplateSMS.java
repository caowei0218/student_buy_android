...
public class SDKTestSendTemplateSMS {
	...
	public static void sendSMS(String phoneNumber, String templateId,
		...
		restAPI.setAccount("8a48b5514eaf512c014eafa5daa00130",
				"497d10fd89954fbb8f9e79976c2917cc");

		// *初始化应用ID *
		// *测试开发可使用“测试Demo”的APP ID，正式上线需要使用自己创建的应用的App ID *
		// *应用ID的获取：登陆官网，在“应用-应用列表”，点击应用名称，看应用详情获取APP ID*
		restAPI.setAppId("8a48b5514eaf512c014eafa7b1080148");
		...
		// *********************************************************************************************************************
		result = restAPI.sendTemplateSMS(phoneNumber, templateId, datas);
